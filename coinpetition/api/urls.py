...
from .views import GameSessionView, CoinSituationView, FinanceQuestionView, SituationAnswerView, UserView, CoinSituationSummaryView
...
urlpatterns = [
    ...
    path('game/<str:session_id>/coin/<str:coin_name>/situation_summary/', CoinSituationSummaryView.as_view(), name='coin_situation_summary'),
